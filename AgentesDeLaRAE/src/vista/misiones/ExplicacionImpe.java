...
public class ExplicacionImpe extends JPanel {

	/**
	 * Create the panel.
	 */
	public ExplicacionImpe(FramePrincipal framePrincipal) {
		setBackground(Color.WHITE);
		setLayout(null);
		setBounds(0,0,800,640);
		
		JLabel lblNewLabel = new JLabel("<html>Estos personajes han cometido un error en sus expresiones.</html>");
		lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblNewLabel.setBounds(147, 120, 366, 44);
		add(lblNewLabel);
		...
		lblImagenespuedesCorregir.setBounds(147, 165, 356, 20);
		...
		btnvamos.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				framePrincipal.CambiaFondo("imperativo");
